        ...
        <>
            <div className="flex flex-col items-center justify-center w-screen h-screen text-center bg-slate-800">
                ...
                <form onSubmit={HandleSubmit} className="w-screen ">
                    <input className="m-2 font-bold bg-blue-200 border-2 border-purple-900 rounded-md w-60 h-1/4 " type="text" name="Username" value={loginfo.Username} placeholder="Username" onChange={HandleChange} required /><br />
                    <input className="m-2 font-bold bg-blue-200 border-2 border-purple-900 rounded-md w-60 h-1/4 " type="text" name="Password" value={loginfo.Password} placeholder="Password" onChange={HandleChange} required /><br /><br />
